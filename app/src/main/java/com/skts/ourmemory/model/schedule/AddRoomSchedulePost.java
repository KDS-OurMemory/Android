...
public class AddRoomSchedulePost {
    ...
    public AddRoomSchedulePost() {
    }

    public AddRoomSchedulePost(int userId, int roomId, String name, String contents, String place, String startDate, String endDate, String firstAlarm, String secondAlarm, String bgColor) {
        this.userId = userId;
        this.roomId = roomId;
        this.name = name;
